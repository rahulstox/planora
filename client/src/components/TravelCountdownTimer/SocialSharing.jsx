...
const SocialSharing = ({ trip, countdownData }) => {
  ...
  const generateDefaultMessage = () => {
    ...
    if (daysUntil === 0) {
      return `🎉 Today is the day! I'm finally traveling to ${destination}, ${country}! ✈️ #planora #Adventure`;
    } else if (daysUntil === 1) {
      return `🚀 Only 1 day until my trip to ${destination}, ${country}! Can't wait! 🌍 #planora #Countdown`;
    } else if (daysUntil <= 7) {
      return `⏰ ${daysUntil} days until my adventure in ${destination}, ${country}! The excitement is real! 🎯 #planora #TravelCountdown`;
    } else {
      return `📅 ${daysUntil} days until I explore ${destination}, ${country}! Starting the countdown! 🗺️ #planora #TravelPlanning`;
    }
  };
  ...
  const socialPlatforms = [
    {
      ...
      params: {
        text: customMessage,
        hashtags: "planora,Travel,Adventure",
      },
    },
    {
      name: "Facebook",
