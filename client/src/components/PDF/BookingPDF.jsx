    ...
    <Document>
      <Page style={styles.page}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>planora - Your Travel Partner</Text>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>
              {bookingData?.guestName || user?.name || "Guest"}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Email:</Text>
            <Text style={styles.value}>
              {user?.email || bookingData?.email || "guest@example.com"}
            </Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Contact:</Text>
            <Text style={styles.value}>
              {bookingData?.contactNumber || "N/A"}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.row}>
            ...
            <Text style={styles.value}>
              {roomTypes[bookingData?.roomType] || "Standard Room"}
            </Text>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>Thank you for choosing planora!</Text>
          <Text style={styles.footerText}>
            Please present this confirmation at check-in.
          </Text>
          <Text style={styles.footerText}>
            For any queries, contact us at support@planora.com
          </Text>
        </View>
      </Page>
    </Document>
