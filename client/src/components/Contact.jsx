    ...
    >
      ...
      >
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          >
            Planning your next adventure? We're here to help make it
            unforgettable!
          </p>
        </div>
      </div>
          ...
          >
            ...
            <div className="space-y-6">
              {contactCards.map((card, index) => (
                <div
                  key={index}
                  className={`flex items-center p-6 backdrop-blur-sm rounded-xl transition-all duration-300 hover:scale-105 shadow-xl ${
                    isDarkMode
                ...
                >
                  <div
                    className={`w-14 h-14 bg-gradient-to-br ${card.iconBg} rounded-xl flex items-center justify-center text-white text-2xl mr-5 shadow-lg`}
                  >
                    {card.icon}
                  </div>
                  <div>
                    ...
                    <p className={`${card.color} font-semibold text-base`}>
                      {card.info}
                    </p>
                    <p
          ...
          >
            ...
            {isSubmitted ? (
              <div className="text-center py-12">
                <div className="w-20 h-20 bg-gradient-to-br from-green-500 to-green-600 rounded-full flex items-center justify-center text-white text-3xl mx-auto mb-6">
                  ✓
                </div>
