      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 items-stretch">
          {features.map((feature, index) => (
            ...
            >
              <div
                className={`backdrop-blur-md rounded-2xl p-8 border transition-all duration-500 hover:scale-105 hover:shadow-2xl h-full ${
                  isDarkMode
              ...
              >
                ...
                <h3
                  className={`text-xl font-semibold mb-4 group-hover:text-pink-300 transition-colors duration-300 break-words ${
                    isDarkMode
