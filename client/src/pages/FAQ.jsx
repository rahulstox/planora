...
const faqs = [
  {
    question: "How do I book flights, trains, or buses on planora?",
    answer:
  ...
  {
    question: "What are planora’s travel packages?",
    answer:
  ...
  {
    question: "How do I manage my planora account?",
    answer:
    ...
    <div className="min-h-[70vh] flex flex-col items-center py-12 px-4 md:px-0">
      <div className="w-full max-w-2xl mx-auto">
        ...
        <p className="text-gray-600 text-lg mb-10 text-center">
          ...
          cancellations, and more on planora.
        </p>
        <div className="space-y-4">
          {faqs.map((faq, idx) => (
            <div
              key={idx}
              className={`rounded-xl border border-pink-200 bg-white shadow-md transition-all duration-300 overflow-hidden ${
                openIndex === idx ? "ring-2 ring-pink-400" : ""
              }`}
            >
              <button
              ...
              >
                <span className="text-lg font-semibold text-pink-600 group-hover:text-pink-700 transition-colors">
                  {faq.question}
                </span>
                <svg
              ...
              <div
                id={`faq-panel-${idx}`}
                className={`px-6 pb-5 text-gray-700 text-base transition-all duration-500 ease-in-out ${
                  openIndex === idx
